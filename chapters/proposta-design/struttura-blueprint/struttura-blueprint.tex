...
La terza iterazione ci ha portato alla realizzazione di un'ulteriore versione  dei bluprint.
\begin{figure}[H]
    \centering
...
\end{figure}
Durante la realizzazione dei Wireframe abbiamo individuato alcune criticità nella \hyperref{ss:seconda-iterazione}{versione due} del blueprint; abbiamo quindi apportato alcune modifiche per risolvere le problematiche individuate:
\begin{itemize}
...
\end{figure}
Successivamente all'\textit{Informat Task Analysis} (\ref{ss:informal-action-analysis}) abbiamo rinominato il nome delle schermate per aiutare maggiormente l'utente a comprendere cosa può fare in ogni schermata.
\begin{itemize}
