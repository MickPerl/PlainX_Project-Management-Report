...
Per testare la nostra riprogettazione, abbiamo ritenuto opportuno perseguire l'approccio Guerrilla (o Discount) usability testing già utilizzato nella \hyperref[s:verifica-risorse-esistenti-testing-utenti]{Sezione 2.3}.\\
...
Purtroppo ciò non è stato possibile, in quanto pochi giornalisti hanno dato la loro disponibilità ad essere ricontattati, nella domanda appositamente inserita nel questionario proposto nella \hyperref[ss:questionario-online]{Sezione 1.2.2} e solo tre hanno poi effettivamente confermato la loro disponibilità a partecipare anche a questo testing.
...
Come nella \hyperref[sss:approccio-adottato]{Sezione 2.3.5} viene di seguito riportata una tabella in cui sono indicati i problemi evidenziati dagli utenti coinvolti nel test, la frequenza con cui si sono presentati e l'impatto ai fini della conclusione del task.
