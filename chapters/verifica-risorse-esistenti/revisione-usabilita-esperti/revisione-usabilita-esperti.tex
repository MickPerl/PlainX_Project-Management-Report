...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Evitare testo in corsivo e utilizzare il testo sottolineato solo per rappresentare i link ad ipertesti;
        \item Il blu saturato è da usare per i dettagli;
        \item Nel contenuto di una pagina, la lunghezza delle linee non è nè troppo corta (inferiore a 50 caratteri per linea) nè troppo lunga (superiore a i 100 caratteri per linea) quando è visualizzata in una finestra di un browser aperto in un dispositivo con uno schermo di grandezza standard;
    \end{enumerate}
    ...
    \item Utilizzo degli strumenti visivi per ricordare all'utente dove si trova all'interno della pagina;
    ...
    \end{enumerate}
    \item Deve essere chiara l'organizzazione che fornisce la dashboard ed è responsabile dei dati ivi presentati (per esempio una foto dell'ufficio o un indirizzo)
    \begin{enumerate}
    ...
    \item La densità degli elementi sullo schermo deve essere adeguata per gli utenti e i loro task;
    ...
    \item La grafica e/o le icone devono essere standard o intuitive;
    \item Le pagine nel sito devono avere un layout consistente;
    \item Le pagine nel sito devono essere formattate per la stampa o c'è una visualizzazione atta a essere e stampata in maniera decorosa. Se possibile, permettere personalizzazioni già fatte;
    \item Deve esserci un buon bilanciamento fra densità di informazione e spazi vuoti/bianchi;
    \item Il colore deve essere usato per dare struttura e raggruppare il contenuto all'interno di una pagina;
    \item Le pagine devono essere progettate utilizzando una struttura a griglia, con elementi e componenti grafiche allineate sia verticalmente che orizzontalmente;
    \item Informazioni e funzioni correlate devono essere raggruppate e ciascun gruppo deve essere identificabile senza spostar lo sguardo (ovvero, una rotazione massima di 5 gradi, approssimativamente un cerchio di diametro di 4.4cm).
\end{enumerate}
...
\begin{enumerate}
    ...
    \item I valori numerici non sono organizzati in blocchi non permettendo un agevole confronto come mostrato in ~\ref{fig:guidelines-violations-3}. Inoltre nel modal evidenziato in viola in ~\ref{fig:guidelines-violations-4} che rappresenta i dati di una regione c'è solo un elencon senza struttura con etichette difficilmente leggibili in quanto scritte con gli underscore al posto degli spazi;
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\columnwidth]{../../../assets/images/verifica-risorse-esistenti/guidelines_violations_3.png}
            \caption{Violazione della linea guida 3: I numeri non sono raggrupati.}
            \label{fig:guidelines-violations-3}
        \end{figure}
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\columnwidth]{../../../assets/images/verifica-risorse-esistenti/guidelines_violations_4.png}
    ...
    \item La memoria funziona meglio riconoscendo gli oggetti:
        \begin{enumerate}
            \item Rispettata;
            \item Il percorso di lettura non è ottimale: i primi quattro riquadri vanno bene ma, il resto, da come si nota in ~\ref{fig:guidelines-violations-5} non è molto chiaro.
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.5\columnwidth]{../../../assets/images/verifica-risorse-esistenti/guidelines_violations_5.png}
    ...
    \item Rispettata;
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\columnwidth]{../../../assets/images/verifica-risorse-esistenti/guidelines_violations_6.png}
            \caption{Violazione della linea guida 5.b: il percorso di lettura non è ottimale.}
    ...
    \item Flessibilità ed efficienza all'uso:
        \begin{enumerate}
            \item Un utente "PRO" non ha modo di salvare le sue preferenze/modalità di visualizzazione;
            \item Non ci sono shortcut utilizzabili.
        \end{enumerate}
