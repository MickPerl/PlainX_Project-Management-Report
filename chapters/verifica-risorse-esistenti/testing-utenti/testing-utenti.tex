...
\begin{enumerate}
    ...
    \begin{enumerate}[label=\alph*.]
        ...
        \item ripetere gli step \hyperref[taa:c]{3.c}, \hyperref[taa:d]{3.d}, \hyperref[taa:e]{3.e} e \hyperref[taa:f]{3.f} finquando non si è raggiunto il 30 aprile '20;
    \end{enumerate}
    \item analizzare la distribuzione del totale dei casi e dei decessi per diverse fasce di età;
    \begin{enumerate}[label=\alph*.]
        \item  Non è stato possibile definire alcun happy path, dal momento che la dashboard non fornisce il dato relativo alle disponibilità dei reparti di terapia intensiva;
    ...
    \begin{enumerate}[label=\alph*.]
        ...
        \item ripetere gli step \hyperref[at:b]{6.b}, \hyperref[at:c]{6.c} finquando non si è raggiunto il 30 aprile '20; \label{at:d}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\columnwidth]{verifica-risorse-esistenti/urgency-curve-michele}
