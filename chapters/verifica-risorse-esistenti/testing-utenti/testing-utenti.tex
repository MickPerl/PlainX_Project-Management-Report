...
\begin{longtable}{|c|p{8cm}|p{5cm}|c|}
    \hline
    ...
    2 & L'utente dalla dashboard clicca su ``Schede riepilogo PDF" come ultima spiaggia per trovare il dato ``tamponi effettuati", ma non trova subito il bollettino in pdf che cerca (quello giornaliero pubblicato dalle agenzie di stampa alle ore 17-18) & 10\% (Potenzialmente bassa, dipende se il giornalista già sa che là dentro troverà - forse - quello che cerca) & Basso \\ \hline
